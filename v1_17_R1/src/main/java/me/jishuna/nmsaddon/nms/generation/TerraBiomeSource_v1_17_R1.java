...
import me.jishuna.nmsaddon.nms.NMSUtils_v1_17_R1;
...
public class TerraBiomeSource_v1_17_R1 extends WorldChunkManager {
	...
	public static final Codec<TerraBiomeSource_v1_17_R1> CODEC = RecordCodecBuilder.create(instance -> instance
			...
			.apply(instance, instance.stable(TerraBiomeSource_v1_17_R1::new)));
	...
	public TerraBiomeSource_v1_17_R1(IRegistry<BiomeBase> biomes, long seed, ConfigPack pack) {
	...
	public BiomeBase getBiome(int biomeX, int biomeY, int biomeZ) {
		...
		return biomeRegistry.get(new MinecraftKey("terra", NMSUtils_v1_17_R1.createBiomeID(pack, biome.getID())));
	}
	...
	public WorldChunkManager a(long var1) {
		return new TerraBiomeSource_v1_17_R1(this.biomeRegistry, seed, pack);
	}
